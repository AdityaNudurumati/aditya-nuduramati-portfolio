...
export const aboutParagraphs = [
  'I’m a Software Engineer at AquaExchange, where I build Flutter applications for mobile, web, and TV. The domain is aquaculture and IoT: farms running thousands of connected devices that need to be monitored in real time, often from places where the network is unreliable.',
...
export const aboutHighlights = [
  ...
  },
  {
    id: 'domain',
    label: 'Domain',
    value: 'Real-time IoT monitoring and aquaculture management',
  },
  {
    id: 'education',
    label: 'Education',
    value: 'B.Tech ECE — RGUKT Srikakulam (IIIT-AP)',
  },
];
